...
jsPsych.plugins["face-fixation-image-keyboard-release-china"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('face-fixation-image-keyboard-release-china', 'stimulus', 'image');

  plugin.info = {
    name: 'face-fixation-image-keyboard-release-china',
    description: '',
    parameters: {		
      picture: {
  ...
  plugin.trial = function(display_element, trial) {
            ...
            document.body.style.backgroundImage = "url('Stim1H/China_flag_background.jpg')";
    ...
    var response = {
      ...
      key: null
		...
		//pre-fixation-stimulus
			...
			var html = '<img src="'+trial.pre_fixation+'" id="jspsych-face-fixation-image-keyboard-release-china-stimulus" style="';
		...
		jsPsych.pluginAPI.setTimeout( 
			...
			var html_3 = '<img src="'+trial.fixation+'" id="jspsych-face-fixation-image-keyboard-release-china-stimulus" style="';
			...
			document.getElementById("jspsych-face-fixation-image-keyboard-release-china-stimulus").src = trial.fixation;
    ...
    // display stimulus
				...
				jsPsych.pluginAPI.setTimeout( 
					function() {
						...
						document.getElementById("jspsych-face-fixation-image-keyboard-release-china-stimulus").src = trial.stimulus;
						...
						var after_response = function(info) {
							...
							display_element.querySelector('#jspsych-face-fixation-image-keyboard-release-china-stimulus').className += ' responded';
						...
						if (trial.stimulus_duration !== null) {
							jsPsych.pluginAPI.setTimeout(function() {
								display_element.querySelector('#jspsych-face-fixation-image-keyboard-release-china-stimulus').style.visibility = 'hidden';		
