...
jsPsych.plugins["face-fixation-image-keyboard-release-usa"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('face-fixation-image-keyboard-release-usa', 'stimulus', 'image');

  plugin.info = {
    name: 'face-fixation-image-keyboard-release-usa',
    description: '',
    parameters: {	
	  picture: {
  ...
  plugin.trial = function(display_element, trial) {
            ...
            document.body.style.backgroundImage = "url('Stim1H/USA_flag_background.jpg')";
    ...
    var response = {
      ...
      key: null
		...
		//pre-fixation-stimulus
			...
			var html = '<img src="'+trial.pre_fixation+'" id="jspsych-face-fixation-image-keyboard-release-usa-stimulus" style="';
		...
		jsPsych.pluginAPI.setTimeout( 
			...
			var html_3 = '<img src="'+trial.fixation+'" id="jspsych-face-fixation-image-keyboard-release-usa-stimulus" style="';
			...
			document.getElementById("jspsych-face-fixation-image-keyboard-release-usa-stimulus").src = trial.fixation;
    ...
    // display stimulus
				...
				jsPsych.pluginAPI.setTimeout( 
					function() {
						...
						document.getElementById("jspsych-face-fixation-image-keyboard-release-usa-stimulus").src = trial.stimulus;
						...
						var after_response = function(info) {
							...
							display_element.querySelector('#jspsych-face-fixation-image-keyboard-release-usa-stimulus').className += ' responded';
						...
						if (trial.stimulus_duration !== null) {
							jsPsych.pluginAPI.setTimeout(function() {
								display_element.querySelector('#jspsych-face-fixation-image-keyboard-release-usa-stimulus').style.visibility = 'hidden';		
