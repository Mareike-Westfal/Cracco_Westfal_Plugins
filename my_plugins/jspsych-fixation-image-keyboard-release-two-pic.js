...
jsPsych.plugins["fixation-image-keyboard-release-two-pic"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('fixation-image-keyboard-release-two-pic', 'stimulus', 'image');

  plugin.info = {
    name: 'fixation-image-keyboard-release-two-pic',
    description: '',
    parameters: {
      picture: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var response = {
      ...
      key: null
		...
		var html = '<img src="'+trial.fixation+'" id="jspsych-fixation-image-keyboard-release-two-pic-stimulus" style="';
    ...
    // display stimulus
		...
		jsPsych.pluginAPI.setTimeout( 
			function() {
				...
				document.getElementById("jspsych-fixation-image-keyboard-release-two-pic-stimulus").src = trial.stimulus;
				...
				var after_response = function(info) {
					...
					display_element.querySelector('#jspsych-fixation-image-keyboard-release-two-pic-stimulus').className += ' responded';
				...
				if (trial.stimulus_duration !== null) {
					jsPsych.pluginAPI.setTimeout(function() {
						display_element.querySelector('#jspsych-fixation-image-keyboard-release-two-pic-stimulus').style.visibility = 'hidden';		
